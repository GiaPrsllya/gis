...
<body>
    ...
    <div class="info">
        ...
        <p>
            <img src="https://upload.wikimedia.org/wikipedia/commons/1/18/Logo-licence-ouverte2.svg"
                style="float:left; height:3em; margin-right:.5em;" />
            <img src="https://static.data.gouv.fr/avatars/1b/e4985396724faf9f6e1122baa7b65c.gif"
                style="float:left; height:3em; margin-right:.5em; background:#fff;" />
            The graph used in this example is <a href="https://www.data.gouv.fr/fr/datasets/route-120/">ROUTE
                120&reg;</a>,
    ...
    <div class="options">
        ...
        <ul>
            <li>
                ...
                <br />
                <label><input id="path" name="view" type="radio" onclick="nodes.setVisible(false)"> show
                    path</label>
            </li>
            <li>
                <hr />
    ...
    <script type="text/javascript">
        ...
        var map = new ol.Map({
            ...
            view: new ol.View({
                zoom: 15,
                center: ol.proj.fromLonLat([107.57894468359882, -6.877402021959739])
            }),
            layers: layers
        });
        ...
        // graph.addFeatures(features);
        var graph = new ol.source.Vector({
            url: "{{asset('assets/data/ROUTE120.geojson')}}",
